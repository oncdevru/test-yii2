...
echo "<div class=\"col-xs-12\"> Разделы: <a href=\"\works\">Все</a> | <a href=\"?tag=cs\">C#</a> | <a href=\"?tag=jquery\">jQuery</a></div></div><div class=\"row\">";
 foreach ($model as $models){
     ...
     if ($i<=3) {
         echo "<div class=\"col-lg-4\"><a href=\"/works?entry=$models->slug\" class=\"woblock\"><img class = \"pr_pic\"  src=\"/images/$models->picture\"><div class=\"plink\" >$models->title</div></a></div>";
         $i++;
     }else if ($i>3){
         echo "</div>";
         echo "<div class=\"row\">";
         echo "<div class=\"col-lg-4\"><div class=\"woblock\"><img class = \"pr_pic\" src=\"/images/$models->picture\"><a class=\"plink\" href=\"/works?entry=$models->slug\" >$models->title</a></div></div>";
         $i=1;
     }
